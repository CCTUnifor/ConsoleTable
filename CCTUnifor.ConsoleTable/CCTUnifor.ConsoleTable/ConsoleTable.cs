...
namespace CCTUnifor.ConsoleTable
{
    public class ConsoleTable
    {
        ...
        private static void Print(string v) => Logger.Logger.Print(v);
        private static void PrintLine(string v) => Logger.Logger.PrintLn(v);
    }
